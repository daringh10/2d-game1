...
public class CharacterController2D : MonoBehaviour {
    ...
    //Transform below rigidbody to check to see if should play landing animation
	...
	void Update()
	{
        ...
        if (Input.GetKeyUp("s") )
        {
            ...
            _animator.SetBool("isCrouching", canCrouch);
        ...
        _animator.SetBool("jumpPressedAgain", jumpPressedAgain);
        ...
        _animator.SetFloat("Velocity", _vy);
